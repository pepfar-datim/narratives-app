...
unique_mechs<-unique(country_data$code)
...
mech_data<-country_data %>%  
  dplyr::filter(code == unique_mechs[y]) %>%
  dplyr::arrange(`Data`)
  
cat(paste0("### Mechanism: ",mech_data$mechanism[1]))
cat('\n\n') 
cat(paste0("**Agency: ",mech_data$agency[1],"**"))
cat('\n\n')
cat(paste0("**Partner: ",mech_data$partner[1],"**"))
cat('\n\n')
